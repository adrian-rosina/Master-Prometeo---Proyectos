...
const rockArray = [];
let position = albums[0];
for (let album of albums){
    if (album.genre ==="Rock"){
        rockArray.push(album);
    }
}


totalDuration = 0;
for (let rock of rockArray){
    totalDuration += rock.duration
}

console.log("Duración de los albunes de rock", totalDuration);
